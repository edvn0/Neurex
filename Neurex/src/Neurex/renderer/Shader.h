...
public:
	...
	virtual void upload_uniform(
		const std::string& name, const glm::mat4& float4_matrix)
		= 0;
	virtual void upload_uniform(
		const std::string& name, const glm::vec4& float4_vec)
		= 0;
	virtual void upload_uniform(
		const std::string& name, const glm::vec3& float3_vec)
		= 0;
	virtual void upload_uniform(
		const std::string& name, const glm::vec2& float2_vec)
		= 0;
