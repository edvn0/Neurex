...
void Renderer2D::init()
{
	...
	uint32_t squareIndices[6] = { 0, 1, 2, 2, 3, 1 };
	...
	render_data->shader = Shader::create("assets/shaders/texture.glsl");
...
void Renderer2D::draw_rotated_quad(const glm::vec3& pos, const glm::vec3& rot, const glm::vec2& size, const glm::vec4& colour)
{
	...
	glm::mat4 transform = glm::translate(glm::mat4(1.0f), pos) * glm::rotate(glm::mat4(1.0f), glm::radians(rot.x), { 0.0, 0.0, 1.0f }) * glm::scale(glm::mat4(1.0f), { size.x, size.y, 1.0f });
