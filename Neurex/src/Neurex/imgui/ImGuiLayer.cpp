...
void ImGuiLayer::on_event(Event& event)
{
	...
	if (!block) {
		...
		auto& io = ImGui::GetIO();
		event.get_handled() |= event.is_in_category(EventCategoryMouse) & io.WantCaptureMouse;
		event.get_handled() |= event.is_in_category(EventCategoryKeyboard) & io.WantCaptureKeyboard;
