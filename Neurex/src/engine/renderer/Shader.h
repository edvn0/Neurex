...
public:
	...
	virtual void upload_uniform(const std::string& name, int* vals, uint32_t count) = 0;
	...
	virtual void set_float(const std::string& name, float val) { upload_uniform(name, val); };
	virtual void set_int_array(const std::string& name, int* vals, uint32_t count)
	{
